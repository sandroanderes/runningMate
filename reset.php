	...
	<div class="row h-100 justify-content-center align-items-center">
		<div class="col-10 col-md-8 col-lg-6">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<p><a class="text-blue" href='./'>Back to login page</a></p>
				<hr>
				...
				<hr>
				<div class="row">
					<div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Sent Reset Link" class="btn btn-blue btn-block btn-lg" tabindex="2"></div>
				</div>
			</form>
		</div>
	</div>
